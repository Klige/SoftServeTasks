...
public class QuadraticEquation {
    private double a;
    private double b; //Коэффициенты квадратного уравнения ax^2+bx+c
    private double c;
    ...
    public QuadraticEquation(double a, double b, double c, double root1, double root2, double determinant) {
        this.a = a;
        this.b = b;
        this.c = c;
        this.root1 = root1;
    ...
    public String toString() {
        if (determinant > 0) {
            ...
            String fImag = new DecimalFormat("#.##").format(result.getImag());
