...
public class QuadraticEquationMath {
    ...
    public static void resolveQuadraticEquation(QuadraticEquation equation) {
        ...
        if (determinant > 0) {
            ...
            double imag = Math.sqrt(-determinant) / (2 * equation.getA());
            equation.setResult(new ComplexNumber(real, imag));
        }
    }
}
